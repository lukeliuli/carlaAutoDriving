...
import cv2
from useultralytics  import  process_carla_imageseg  
...
def img_process(image):
    ...
    mask_image, annotated_image = process_carla_imageseg(array)  # 调用图像处理函数
    # 显示图像
    #cv2.imshow('CARLA RGB Sensor', array)
    #cv2.waitKey(100)
    if mask_image is not None:
        str1 = 'out/outputMask%06d.jpg' % image.frame
        cv2.imwrite(str1, mask_image)
        str1 = 'out/outputannotated%06d.jpg' % image.frame
        cv2.imwrite(str1, annotated_image)
